...
Read and follow [prompts/assess-project.prompt.md](../prompts/assess-project.prompt.md)
as the procedure. Do not summarise or shortcut it — load the file and execute
every step. Change nothing. Present the assessment and await the human's pick.

...
`.prompt.md` files that define specific, reusable workflows: code review, docstring
generation, rule extraction, commit messages, and more.
...
Examples: `generate-docstrings`, `code-review`, `refactor-pyspark`, `commit-message`.

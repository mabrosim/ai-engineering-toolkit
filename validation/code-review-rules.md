...
Checklist and rules for reviewing code in externally assessed projects (via `aet-review` / `AET Orchestrator`). This repository holds no application source of its own.
